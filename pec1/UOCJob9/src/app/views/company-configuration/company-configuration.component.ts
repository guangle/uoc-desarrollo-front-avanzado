...
export class CompanyConfigurationComponent implements OnInit {
  ...
  createForm() {
    console.log("Creando el formulario de edición de configuración de la empresa");
  ...
  submitConfiguration() {
    ...
    if (this.configurationForm.valid) {
      this.company.idioma_app = this.idiomas.find(i => i.uid == this.configurationForm.get("language").value);
